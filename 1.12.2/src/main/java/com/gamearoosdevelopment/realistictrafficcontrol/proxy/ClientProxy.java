...
public class ClientProxy extends CommonProxy {
	...
	{
		super.preInit(e);
		ModelLoaderRegistry.registerLoader(new com.gamearoosdevelopment.realistictrafficcontrol.blocks.model.ModelLoader());
	}
...
//		ProgressManager.pop(progressBar);
		...
		entityClassRendererKey = new KeyBinding("key.entityclassrenderer.toggle", Keyboard.KEY_RBRACKET, "key.realistictrafficcontrol.category");
