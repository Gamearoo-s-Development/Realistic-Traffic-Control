...
public class Type3BarrierTileEntity extends SyncableTileEntity {
	...
	public Sign getThisSign()
	{
		...
		{
			sign = ModRealisticTrafficControl.instance.signRepo.getSignByTypeVariant(SignTileEntity.getSignTypeName(thisSignTypeLegacy), thisSignVariantLegacy);
		}
		else if (thisSignID != null)
		{
			sign = ModRealisticTrafficControl.instance.signRepo.getSignByID(thisSignID);
		}
