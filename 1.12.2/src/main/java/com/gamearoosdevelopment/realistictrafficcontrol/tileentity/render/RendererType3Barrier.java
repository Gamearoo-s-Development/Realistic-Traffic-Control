...
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.Type3BarrierTileEntity.SignType;
...
public class RendererType3Barrier extends TileEntitySpecialRenderer<Type3BarrierTileEntity> {
	...
	private void renderAllSign(Type3BarrierTileEntity te, double x, double y, double z)
	{
		...
		bindTexture(new ResourceLocation("realistictrafficcontrol", "textures/blocks/road_closed_sign.png"));
		...
		// Render sign back
		bindTexture(new ResourceLocation("realistictrafficcontrol", "textures/blocks/generic.png"));
		builder.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
