...
public class BlockQuietZoneSignal extends Block {
	public static PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	public BlockQuietZoneSignal()
	{
		super(Material.IRON);
		setRegistryName("quiet_zone_signal");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".quiet_zone_signal");
