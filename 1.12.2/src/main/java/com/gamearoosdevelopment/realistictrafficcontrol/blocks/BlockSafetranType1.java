...
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.SafetranType1TileEntity;
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.TeardropBellTileEntity;
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.WCHMechanicalBellTileEntity;
...
public class BlockSafetranType1 extends Block implements ITileEntityProvider
{
	public static final PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	public BlockSafetranType1()
	{
		super(Material.IRON);
		setRegistryName("safetran_type_1");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".safetran_type_1");
		setHardness(2f);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new SafetranType1TileEntity();
	}
