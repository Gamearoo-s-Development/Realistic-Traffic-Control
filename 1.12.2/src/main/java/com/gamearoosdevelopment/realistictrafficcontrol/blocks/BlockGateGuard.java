...
public class BlockGateGuard extends Block
{
    public static PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
    public BlockGateGuard()
    {
        super(Material.ROCK);
        setRegistryName("gate_guard");
        setUnlocalizedName(ModRealisticTrafficControl.MODID + ".gate_guard");
        setLightOpacity(1);
        setHardness(1f);
