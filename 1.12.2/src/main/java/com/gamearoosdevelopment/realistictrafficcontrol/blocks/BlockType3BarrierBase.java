...
public abstract class BlockType3BarrierBase extends Block {
	...
	public BlockType3BarrierBase()
	{
		...
		setCreativeTab(ModRealisticTrafficControl.BARRIERS_TAB);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(ModRealisticTrafficControl.instance, GuiProxy.GUI_IDs.TYPE_3_BARRIER, worldIn, barrierTE.getPos().getX(), barrierTE.getPos().getY(), barrierTE.getPos().getZ());
		return true;
	}
