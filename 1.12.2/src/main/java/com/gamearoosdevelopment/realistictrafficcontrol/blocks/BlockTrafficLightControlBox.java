...
public class BlockTrafficLightControlBox extends Block implements ITileEntityProvider {
	...
	public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag flag)
	{
		...
		{
			String info = I18n.format("realistictrafficcontrol.tooltip.trafficbox");
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(ModRealisticTrafficControl.instance, GuiProxy.GUI_IDs.TRAFFIC_LIGHT_CONTROL_BOX, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
