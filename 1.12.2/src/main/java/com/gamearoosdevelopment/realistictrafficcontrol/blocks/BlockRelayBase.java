...
public abstract class BlockRelayBase extends Block implements ITileEntityProvider {
	...
	public BlockRelayBase()
	{
		...
		setUnlocalizedName(ModRealisticTrafficControl.MODID + "." + registryName());
		setHardness(2);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(ModRealisticTrafficControl.instance, GuiProxy.GUI_IDs.CROSSING_RELAY_SETTINGS, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
