...
public class BlockTeardropBell extends Block implements ITileEntityProvider
{
	public static final PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	
	public BlockTeardropBell()
	{
		super(Material.IRON);
		setRegistryName("teardrop_bell");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".teardrop_bell");
		setHardness(2f);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TeardropBellTileEntity();
	}
