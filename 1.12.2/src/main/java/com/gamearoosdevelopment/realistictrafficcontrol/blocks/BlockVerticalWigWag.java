...
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.render.RendererWigWag;
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.render.VerticalWigWagRenderer;
...
public class BlockVerticalWigWag extends Block implements ITileEntityProvider
{
	...
	public BlockVerticalWigWag()
	{
		...
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".vertical_wig_wag");
		setHardness(1f);
