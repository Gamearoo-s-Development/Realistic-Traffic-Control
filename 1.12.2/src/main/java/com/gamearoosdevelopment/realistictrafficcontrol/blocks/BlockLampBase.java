...
import com.gamearoosdevelopment.realistictrafficcontrol.gui.GuiProxy.GUI_IDs;
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.CrossingLampsTileEntity;
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.render.CrossingLampsRenderer;
...
public abstract class BlockLampBase extends Block {
	...
	public BlockLampBase()
	{
		...
		setUnlocalizedName(ModRealisticTrafficControl.MODID + "." + getLampRegistryName());
		setHardness(2f);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(ModRealisticTrafficControl.instance, GUI_IDs.CROSSING_GATE_LAMPS, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
