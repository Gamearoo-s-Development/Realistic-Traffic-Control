...
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.render.StreetLightSingleRenderer;
...
public class BlockStreetLightSingle extends Block implements ITileEntityProvider {
	...
	public BlockStreetLightSingle()
	{
		...
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".street_light_single");
		setHardness(2f);
