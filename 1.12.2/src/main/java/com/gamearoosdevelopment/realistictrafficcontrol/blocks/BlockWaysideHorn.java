...
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.WaysideHornTileEntity;
...
public class BlockWaysideHorn extends Block
{
	public static PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	public BlockWaysideHorn()
	{
		super(Material.IRON);
		setRegistryName("wayside_horn");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".wayside_horn");
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new WaysideHornTileEntity();
	}
