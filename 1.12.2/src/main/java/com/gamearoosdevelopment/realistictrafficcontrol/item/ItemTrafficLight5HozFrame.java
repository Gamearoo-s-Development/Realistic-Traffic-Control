...
public class ItemTrafficLight5HozFrame extends BaseItemTrafficLightFrame
{
	public ItemTrafficLight5HozFrame()
	{
		super("traffic_light_5_hoz_frame");
	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) 
	{
		...
		if (subStack != ItemStack.EMPTY)
		{
			tooltip.add("Bottom 2: " + subStack.getItem().getItemStackDisplayName(subStack));
		}
	}
	...
	{
		return ModBlocks.traffic_light_5_hoz;
	}

	@Override
	protected int getGuiID() 
	{
		return GuiProxy.GUI_IDs.TRAFFIC_LIGHT_5_HOZ_FRAME;
	}
}
