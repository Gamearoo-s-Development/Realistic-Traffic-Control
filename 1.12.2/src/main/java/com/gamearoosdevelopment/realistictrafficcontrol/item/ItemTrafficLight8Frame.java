...
public class ItemTrafficLight8Frame extends BaseItemTrafficLightFrame
{
	public ItemTrafficLight8Frame()
	{
		super("traffic_light_8_frame");
	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) 
	{
		...
		if (subStack != ItemStack.EMPTY)
		{
			tooltip.add("Buttom Left: " + subStack.getItem().getItemStackDisplayName(subStack));
		}
		
		subStack = handler.getStackInSlot(3);
		if (subStack != ItemStack.EMPTY)
		{
			tooltip.add("Bottom Right: " + subStack.getItem().getItemStackDisplayName(subStack));
		}
	}
	...
	{
		return ModBlocks.traffic_light_8;
	}

	@Override
	protected int getGuiID() 
	{
		return GuiProxy.GUI_IDs.TRAFFIC_LIGHT_8_FRAME;
	}
}
