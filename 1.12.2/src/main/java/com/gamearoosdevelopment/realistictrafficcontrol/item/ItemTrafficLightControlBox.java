...
public class ItemTrafficLightControlBox extends ItemBlock
{
    public ItemTrafficLightControlBox(Block block)
    {
        super(block);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        {
            String info = I18n.format("realistictrafficcontrol.tooltip.cone");
