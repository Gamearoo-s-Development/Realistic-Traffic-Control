...
public class GuiButtonToggle2 extends GuiButton {
    private boolean toggled;

    public GuiButtonToggle2(int id, int x, int y, int width, int height, boolean initialState) {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        if (this.visible) {
            ...
            String label = toggled ? "Main Street: North" : "Main Street: West";
