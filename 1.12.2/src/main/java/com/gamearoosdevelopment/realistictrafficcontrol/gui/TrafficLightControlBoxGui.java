...
public class TrafficLightControlBoxGui extends GuiScreen {
	...
	private void drawHoveredText(int mouseX, int mouseY, String type) {
		...
		case "leftgreen":
			...
			break;
		case "red":
			text = "Solid Red, Striaght Arrow Red and X";
			drawHoveringText(text, mouseX, mouseY);
			break;
		case "yellow":
			...
			break;
		case "green":
			text = "Solid Green, Striaght Arrow Green and Green Arrow Down";
			drawHoveringText(text, mouseX, mouseY);
			break;
...
//	These are var's for what lets the code know what texture to should for special bulbs 
	...
	private String isGreen = "Green";
	private Boolean isGreenDownArrow = true;
	...
	private void drawGreenBulb(int horizontalCenter, int verticalCenter) {
		...
		TextureMap textureMap = mc.getTextureMapBlocks();
		 ...
		 } else  if(isGreen == "DGreen") {
			 textureGreen = new ResourceLocation("realistictrafficcontrol:blocks/green_down");
		 } else  if(isGreen == "SGreen") {
	...
	private void drawRedBulb(int horizontalCenter, int verticalCenter) {
		...
		TextureMap textureMap = mc.getTextureMapBlocks();
		 ...
		 if(isRed == "Red") {
			 ...
			 textureRed = new ResourceLocation("realistictrafficcontrol:blocks/x_dithered");
		 } else if(isRed == "SRed"){
