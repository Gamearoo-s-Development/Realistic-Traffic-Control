...
public class TrafficLight5FrameContainer extends BaseTrafficLightFrameContainer {
	...
	protected List<FrameSlotInfo> buildSlotInfo() {
		return ImmutableList
			...
			.add(new FrameSlotInfo(EnumCheckboxOrientation.RIGHT, 0, 79, 12))
			.add(new FrameSlotInfo(EnumCheckboxOrientation.RIGHT, 1, 79, 44))
			.add(new FrameSlotInfo(EnumCheckboxOrientation.RIGHT, 2, 79, 76))
			.add(new FrameSlotInfo(EnumCheckboxOrientation.RIGHT, 3, 79, 107))
			.add(new FrameSlotInfo(EnumCheckboxOrientation.RIGHT, 4, 79, 139))
			.build();
	}
