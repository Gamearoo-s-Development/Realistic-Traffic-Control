...
public class GuiButtonToggleHawk extends GuiButton {
    private boolean toggled;

    public GuiButtonToggleHawk(int id, int x, int y, int width, int height, boolean initialState) {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        if (this.visible) {
            ...
            String label = toggled ? "HAWK: ON" : "HAWK: OFF";
