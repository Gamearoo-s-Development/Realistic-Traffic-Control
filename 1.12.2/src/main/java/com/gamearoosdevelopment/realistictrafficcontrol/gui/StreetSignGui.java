...
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.StreetSign.StreetSignColors;
...
public class StreetSignGui extends GuiScreen {
	...
	public void initGui() {
		...
		ResourceLocation image = new ResourceLocation("realistictrafficcontrol:textures/blocks/street_sign.png");
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		for(int i = 0; i < StreetSignTileEntity.MAX_STREET_SIGNS; i++)
		{
			...
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("realistictrafficcontrol:textures/blocks/street_sign.png"));
