...
public class GuiButtonToggleSplitDirections extends GuiButton {
	private boolean toggled;

	public GuiButtonToggleSplitDirections(int id, int x, int y, int width, int height, boolean initialState) {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
		if (this.visible) {
			...
			String label = toggled ? "Split Dir: ON" : "Split Dir: OFF";
