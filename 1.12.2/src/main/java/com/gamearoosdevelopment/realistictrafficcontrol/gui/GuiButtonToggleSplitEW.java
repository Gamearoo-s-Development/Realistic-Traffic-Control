...
public class GuiButtonToggleSplitEW extends GuiButton {
	private boolean toggled;

	public GuiButtonToggleSplitEW(int id, int x, int y, int width, int height, boolean initialState) {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
		if (this.visible) {
			...
			String label = toggled ? "Split EW: ON" : "Split EW: OFF";
