...
public class StreetLightSingleBlockEntityRenderer implements BlockEntityRenderer<StreetLightSingleBlockEntity> {
    ...
    public StreetLightSingleBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(StreetLightSingleBlockEntity te, float partialTick, PoseStack poseStack,
