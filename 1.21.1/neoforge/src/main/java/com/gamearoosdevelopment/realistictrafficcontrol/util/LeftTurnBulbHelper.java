...
public final class LeftTurnBulbHelper {
    ...
    public static void setGreen(TrafficLightBlockEntity tl, boolean flash) {
    ...
    public static void setYellow(TrafficLightBlockEntity tl, boolean flash) {
    ...
    public static void setRed(TrafficLightBlockEntity tl, boolean flash) {
    ...
    public static void clear(TrafficLightBlockEntity tl) {
