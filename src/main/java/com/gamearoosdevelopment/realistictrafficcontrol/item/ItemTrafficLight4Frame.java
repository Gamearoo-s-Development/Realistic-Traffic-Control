...
public class ItemTrafficLight4Frame extends BaseItemTrafficLightFrame
{
	public ItemTrafficLight4Frame()
	{
		super("traffic_light_4_frame");
	}
	...
	{
		return GuiProxy.GUI_IDs.TRAFFIC_LIGHT_4_FRAME;
	}
}
