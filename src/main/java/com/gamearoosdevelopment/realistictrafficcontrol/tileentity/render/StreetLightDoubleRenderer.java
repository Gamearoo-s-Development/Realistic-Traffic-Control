...
public class StreetLightDoubleRenderer extends TileEntitySpecialRenderer<StreetLightDoubleTileEntity> {
	private static final ResourceLocation generic = new ResourceLocation(ModRealisticTrafficControl.MODID, "textures/blocks/generic.png");
	private static final ResourceLocation yellow = new ResourceLocation(ModRealisticTrafficControl.MODID, "textures/blocks/yellow.png");
	...
	public void render(StreetLightDoubleTileEntity te, double x, double y, double z, float partialTicks,
		...
		boxes.add(new Box(7, 65.35, -23.2, 2, 2, 16, armBoxCollection, true));
		boxes.add(new Box(5, 64.35, -23.2, 1, 1, 14, armBoxCollection, true));
		boxes.add(new Box(10, 64.35, -23.2, 1, 1, 14, armBoxCollection, true));
		boxes.add(new Box(6, 64.35, -23.2, 4, 1, 1, armBoxCollection, true));
		boxes.add(new Box(6, 64.35, -10.2, 4, 1, 1, armBoxCollection, true));
		boxes.add(new Box(6, 65.34, -23.2, 4, 0, 14, armBoxCollection, true));
		...
		GlStateManager.rotate(20, 1, 0, 0);
		GlStateManager.translate(0, 0.34375, -1.0625);
		GlStateManager.rotate(20, 1, 0, 0);

		builder.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
		rotatedArmBox = new Box(0, 0, 0, 2, 2, 16, armBoxCollection, true);
		rotatedArmBox.render(builder, rl -> texManager.bindTexture(rl));
		tess.draw();
