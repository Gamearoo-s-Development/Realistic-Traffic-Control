...
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.CrossingGateGateTileEntity.GateLightCount;
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.render.TESRHelper.Box;
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.render.TESRHelper.TextureInfo;
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.render.TESRHelper.TextureInfoCollection;
...
public class RendererCrossingGateGate extends TileEntitySpecialRenderer<CrossingGateGateTileEntity> {
	...
	{
		// Rotator Cross
		ResourceLocation generic = new ResourceLocation(ModRealisticTrafficControl.MODID + ":textures/blocks/generic.png");
	...
	{
		ResourceLocation gate = new ResourceLocation(ModRealisticTrafficControl.MODID + ":textures/blocks/gate.png");
		TextureInfoCollection collection = new TextureInfoCollection(
	...
	private final ModelResourceLocation lightOffLocation = new ModelResourceLocation(ModRealisticTrafficControl.MODID + ":crossing_gate_light", "normal");
	private final ModelResourceLocation lightOnLocation = new ModelResourceLocation(ModRealisticTrafficControl.MODID + ":crossing_gate_light", "on=true");
