...
public class SignTileEntity extends TileEntity {
	...
	public Sign getSign()
	{
		...
		if (variantLegacy != -1)
		{
			sign = ModRealisticTrafficControl.instance.signRepo.getSignByTypeVariant(getSignTypeName(typeLegacy), variantLegacy);
		}
		else if (id != null)
		{
			sign = ModRealisticTrafficControl.instance.signRepo.getSignByID(id);
		}
		
		if (sign == null)
		{
			return ModRealisticTrafficControl.instance.signRepo.getSignByID(Sign.DEFAULT_ERROR_SIGN);
		}
	...
	public String getFriendlySignName()
	{
		...
		{
			Sign sign = ModRealisticTrafficControl.instance.signRepo.getSignByID(id);
			if (sign != null)
			{
				return ModRealisticTrafficControl.instance.signRepo.getFriendlyTypeName(sign.getType());
			}
		}
		return "Unknown";
	}
