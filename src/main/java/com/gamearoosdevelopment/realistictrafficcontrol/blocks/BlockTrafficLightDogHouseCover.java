...
public class BlockTrafficLightDogHouseCover extends Block {
	public static PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	public BlockTrafficLightDogHouseCover()
	{
		super(Material.IRON);
		setRegistryName("traffic_lightdoghouse_cover");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".traffic_lightdoghouse_cover");
