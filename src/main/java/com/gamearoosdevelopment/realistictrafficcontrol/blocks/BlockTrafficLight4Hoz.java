...
public class BlockTrafficLight4Hoz extends BlockBaseTrafficLight
{
	public BlockTrafficLight4Hoz()
	{
		super("traffic_light_4_hoz");
	}
	...
	{
		ClientRegistry.bindTileEntitySpecialRenderer(TrafficLight4HozTileEntity.class, new TrafficLight4HozRenderer());
	}
	...
	{
		return new TrafficLight4HozTileEntity();
	}
