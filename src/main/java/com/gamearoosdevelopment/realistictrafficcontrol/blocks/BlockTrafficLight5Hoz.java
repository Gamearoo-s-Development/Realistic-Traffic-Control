...
public class BlockTrafficLight5Hoz extends BlockBaseTrafficLight
{
	public BlockTrafficLight5Hoz()
	{
		super("traffic_light_5_hoz");
	}
	...
	{
		ClientRegistry.bindTileEntitySpecialRenderer(TrafficLight5HozTileEntity.class, new TrafficLight5HozRenderer());
	}
	...
	{
		return new TrafficLight5HozTileEntity();
	}
