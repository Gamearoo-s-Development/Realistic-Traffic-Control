...
public class BlockTrafficLight1Cover extends Block {
	public static PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	public BlockTrafficLight1Cover()
	{
		super(Material.IRON);
		setRegistryName("traffic_light1_cover");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".traffic_light1_cover");
