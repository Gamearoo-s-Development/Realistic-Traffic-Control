...
public class BlockTrafficLight7Cover extends Block {
	...
	public BlockTrafficLight7Cover()
	{
		super(Material.IRON);
		setRegistryName("traffic_light7_cover");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".traffic_light7_cover");
