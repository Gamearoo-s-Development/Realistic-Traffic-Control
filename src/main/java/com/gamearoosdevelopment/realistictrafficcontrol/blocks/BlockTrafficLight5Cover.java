...
public class BlockTrafficLight5Cover extends Block {
	public static PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	public BlockTrafficLight5Cover()
	{
		super(Material.IRON);
		setRegistryName("traffic_light5_cover");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".traffic_light5_cover");
