...
public class BlockTrafficLightCover extends Block {
	...
	{
		super(Material.IRON);
		setRegistryName("traffic_light_cover");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".traffic_light_cover");
