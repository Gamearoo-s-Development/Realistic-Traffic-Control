...
public class BlockTrafficLight2Cover extends Block {
	public static PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	public BlockTrafficLight2Cover()
	{
		super(Material.IRON);
		setRegistryName("traffic_light2_cover");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".traffic_light2_cover");
