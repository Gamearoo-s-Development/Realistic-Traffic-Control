...
public class BlockCrossingGatePole extends Block {
	...
	public boolean getStateIsValidForSubModel(int rotation, BlockPos currentPos, IBlockAccess world, EnumFacing facing)
	{
		...
		if (state.getBlock() instanceof BlockTrafficLightCover)
		{
			int stateRotation = state.getValue(BlockTrafficLightCover.ROTATION);
			if (!CustomAngleCalculator.isCardinal(stateRotation))
			{
				return false;
			}
		...
		if (state.getBlock() instanceof BlockTrafficLight1Cover)
		{
			int stateRotation = state.getValue(BlockTrafficLight1Cover.ROTATION);
			if (!CustomAngleCalculator.isCardinal(stateRotation))
			{
				return false;
			}
		...
		if (state.getBlock() instanceof BlockTrafficLight2Cover)
		{
			int stateRotation = state.getValue(BlockTrafficLight2Cover.ROTATION);
			if (!CustomAngleCalculator.isCardinal(stateRotation))
			{
				return false;
			}
		...
		if (state.getBlock() instanceof BlockTrafficLight4Cover)
		{
			int stateRotation = state.getValue(BlockTrafficLight4Cover.ROTATION);
			if (!CustomAngleCalculator.isCardinal(stateRotation))
			{
				return false;
			}
		...
		if (state.getBlock() instanceof BlockTrafficLight5Cover)
		{
			int stateRotation = state.getValue(BlockTrafficLight5Cover.ROTATION);
			if (!CustomAngleCalculator.isCardinal(stateRotation))
			{
				return false;
			}
		...
		if (state.getBlock() instanceof BlockTrafficLight6Cover)
		{
			int stateRotation = state.getValue(BlockTrafficLight6Cover.ROTATION);
			if (!CustomAngleCalculator.isCardinal(stateRotation))
			{
				return false;
			}
		...
		if (state.getBlock() instanceof BlockTrafficLight7Cover)
		{
			int stateRotation = state.getValue(BlockTrafficLight7Cover.ROTATION);
			if (!CustomAngleCalculator.isCardinal(stateRotation))
			{
				return false;
			}
		...
		if (state.getBlock() instanceof BlockTrafficLightDogHouseCover)
		{
			int stateRotation = state.getValue(BlockTrafficLightDogHouseCover.ROTATION);
			if (!CustomAngleCalculator.isCardinal(stateRotation))
			{
				return false;
			}
