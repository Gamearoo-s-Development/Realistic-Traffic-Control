...
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.render.RendererCrossingGateGate;
...
public class BlockCrossingGateGate extends Block {
	...
	public BlockCrossingGateGate()
	{
		...
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".crossing_gate_gate");
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(ModRealisticTrafficControl.instance, GuiProxy.GUI_IDs.CROSSING_GATE_GATE, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
}
