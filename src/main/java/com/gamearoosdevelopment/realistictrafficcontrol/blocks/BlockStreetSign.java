...
import com.gamearoosdevelopment.realistictrafficcontrol.tileentity.render.StreetSignRenderer;
...
public class BlockStreetSign extends Block {
	public BlockStreetSign()
	{
		...
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".street_sign");
		setLightOpacity(1);
		setHardness(1f);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		Minecraft.getMinecraft().player.openGui(ModRealisticTrafficControl.instance, GuiProxy.GUI_IDs.STREET_SIGN, worldIn, pos.getX(), pos.getY(), pos.getZ());
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		{
			playerIn.openGui(ModRealisticTrafficControl.instance, GuiProxy.GUI_IDs.STREET_SIGN, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
