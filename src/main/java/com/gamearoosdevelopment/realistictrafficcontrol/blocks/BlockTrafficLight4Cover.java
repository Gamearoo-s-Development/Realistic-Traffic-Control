...
public class BlockTrafficLight4Cover extends Block {
	...
	public BlockTrafficLight4Cover()
	{
		super(Material.IRON);
		setRegistryName("traffic_light4_cover");
		setUnlocalizedName(ModRealisticTrafficControl.MODID + ".traffic_light4_cover");
