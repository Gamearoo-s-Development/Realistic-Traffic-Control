...
public class BakedModelStreetLightSingle extends BaseBakedModel {
	...
	public BakedModelStreetLightSingle(VertexFormat format) {
		super(format);
		
		generic = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(ModRealisticTrafficControl.MODID + ":blocks/generic");
		lamp = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(ModRealisticTrafficControl.MODID + ":blocks/yellow");
...
//		EnumFacing facing = state.getValue(BlockStreetLightSingle.FACING);
